...
TRAIN_DATA =[ ("The Baltic Sea stretches from 53°N to 66°N latitude and from 10°E to 30°E longitude.", {"entities": [(0, 14, "WATER")]}),
              ...
              ("Olive Morris (1952–1979) was a Jamaican-born and British-based community leader and activist.", {"entities": []}),
              ("She participated in the Black nationalist, feminist and squatters' rights campaigns of the 1970s.", {"entities": []}),
              ("She joined the British Black Panthers, occupied buildings in Brixton, South London, and became a key organizer in the Black Women's Movement in the United Kingdom.", {"entities": [(61, 68, "CITY"), (70, 82, "AREA"), (144, 162, "COUNTRY")]}),
              ("In London, Morris co-founded the Brixton Black Women's Group and the Organization of Women of African and Asian Descent; when she studied at the Victoria University of Manchester, she was involved in the Manchester Black Women's Co-operative and also travelled to China with the Society for Anglo-Chinese Understanding.", {"entities": [(3, 9, "CITY"), (33, 40, "CITY"), (168, 178, "CITY"), (204, 214, "CITY"), (264, 269, "COUNTRY")]}),
           ]
